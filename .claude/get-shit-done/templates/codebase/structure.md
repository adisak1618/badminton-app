...
- Usage: Reference from command with `@/Users/adisakchaiyakul/project/badminton/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/adisakchaiyakul/project/badminton/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/adisakchaiyakul/project/badminton/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
