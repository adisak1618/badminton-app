...
- **Global scope**: `/Users/adisakchaiyakul/project/badminton/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/adisakchaiyakul/project/badminton/.claude/notes/`)
...
2. Glob `/Users/adisakchaiyakul/project/badminton/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/adisakchaiyakul/project/badminton/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/adisakchaiyakul/project/badminton/.claude/notes/` — works in any directory
